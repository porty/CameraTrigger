...
static void mavlink_test_camera_data(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_camera_data_t packet_in = {
		963497464,
	}963497672,
	}963497880,
	}101.0,
	...
	mavlink_camera_data_t packet1, packet2;
	...
	mavlink_msg_camera_data_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_camera_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_camera_data_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.time_week , packet1.time_week_ms , packet1.roll , packet1.pitch , packet1.yaw , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.hdg , packet1.fix_type , packet1.satellites_visible );
	mavlink_msg_camera_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_camera_data_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.time_week , packet1.time_week_ms , packet1.roll , packet1.pitch , packet1.yaw , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.hdg , packet1.fix_type , packet1.satellites_visible );
	mavlink_msg_camera_data_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_camera_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_camera_data_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.time_week , packet1.time_week_ms , packet1.roll , packet1.pitch , packet1.yaw , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.hdg , packet1.fix_type , packet1.satellites_visible );
	mavlink_msg_camera_data_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
{
	mavlink_test_camera_data(system_id, component_id, last_msg);
